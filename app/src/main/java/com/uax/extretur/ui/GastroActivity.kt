...
class GastroActivity : AppCompatActivity(), OnItemSelectedListener {
    ...
    private fun instancias() {
        listaGastro = arrayListOf(
            ...
            Gastro(
                "Bacalao dorado",
                "- Descripción: Versión extremeña del “bacalhau à Brás” portugués, heredado de la cercanía con Portugal. Lleva bacalao desalado desmigado, salteado con cebolla pochada, huevo batido y patatas paja. \nEl resultado es una mezcla jugosa y sabrosa. Se suele decorar con perejil y aceitunas negras. Plato rápido, económico y muy apreciado en fiestas familiares o como tapa.\n Dónde comerlo:" +
